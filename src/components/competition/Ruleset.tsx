export default function Ruleset() {
    const rules = [
        {
            id: 1,
            content:
                "Tim harus beranggotakan 5-10 orang",
        },
        {
            id: 2,
            content:
    ...
    return (
        <div className="min-h-screen bg-[#E9DCBB] flex justify-left items-center ">
            <div className="w-full flex flex-col md:flex-row gap-8 md:gap-12 items-center md:items-start mb-10 md:mb-0">

                {/* Left Section: Given a defined width (w-7/12)*/}
                <div className="w-full md:w-5/12 flex flex-col items-start md:items-start shrink-0">
                    <img src="./competitionBackground/mascotRuleset2.png" alt="Mascot" className="h-100% w-auto object-contain object-left" />
